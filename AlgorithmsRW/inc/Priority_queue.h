...
///THIRD EXERCISE
/**********************************************MinPriprityQueue***********************************/
template <class data_type> class MinPriorityQueue0
{
	vector<data_type> PQ;
public:
	MinPriorityQueue0();
...
template <class data_type>
MinPriorityQueue0<data_type>::MinPriorityQueue0()
{
	PQ.push_back((data_type)0);
}

template <class data_type>
void MinPriorityQueue0<data_type>::AddLast(data_type data)
{
	PQ.push_back(data);
}

template <class data_type>
int MinPriorityQueue0<data_type>::Root()
{
	return 1;
}
...
template <class data_type>
data_type MinPriorityQueue0<data_type>::GetData(int node)
{
	return PQ.at(node);
}

template <class data_type>
int MinPriorityQueue0<data_type>::Parent(int node)
{
	return (node / 2);
}

template <class data_type>
void MinPriorityQueue0<data_type>::Exchange(int c, int p)
{
	data_type data;
	data = PQ.at(c);
	PQ.at(c) = PQ.at(p);
...
template <class data_type>
data_type MinPriorityQueue0<data_type>::ExtractLastFromPQ()
{
	data_type data;
	data = PQ.back();
	PQ.pop_back();
...
template <class data_type>
bool MinPriorityQueue0<data_type>::HasChildren(int node)
{
	if ((PQ.size() - 1) >= (2 * node))
		return true;
	else
...
template <class data_type>
int MinPriorityQueue0<data_type>::MinChild(int node)
{
	if ((PQ.size() - 1) > (2 * node))
	{
		if (PQ.at(2 * node) < PQ.at(2 * node + 1))
			return (2 * node);
		else
			return (2 * node + 1);
	}
	else if ((PQ.size() - 1) == (2 * node))
		return (2 * node);
	else
	{
		cout << "Node " << node << "doesn't have any children\n";
...
template <class data_type>
void MinPriorityQueue0<data_type>::InsertInPQ(data_type data)
{
	AddLast(data);
	int c = (int)PQ.size() - 1;
	int p = 0;
...
template <class data_type>
data_type MinPriorityQueue0<data_type>::ExtractMinFromPQ()
{
	data_type c = PQ.at(Root());
	PQ.at(Root()) = ExtractLastFromPQ();
	int i = Root();
...
template <class data_type>
void MinPriorityQueue0<data_type>::Show()
{
	vector <int>::iterator Iter;
	cout << "PriorityQueue:\n";
	Iter = PQ.begin();
...
template <class data_type>
data_type MinPriorityQueue0<data_type>::FindMinInPQ()
{
	data_type data = PQ.at(Root());
	return data;
}
...
template <class data_type>
int MinPriorityQueue0<data_type>::SizePQ()
{
	return PQ.size() - 1;
}
...
/**********************************************MaxPriprityQueue***********************************/
template <class data_type> class MaxPriorityQueue0
{
	vector<data_type> PQ;
public:
	MaxPriorityQueue0();
...
template <class data_type>
MaxPriorityQueue0<data_type>::MaxPriorityQueue0()
{
	PQ.push_back((data_type)0);
}

template <class data_type>
void MaxPriorityQueue0<data_type>::AddLast(data_type data)
{
	PQ.push_back(data);
}

template <class data_type>
int MaxPriorityQueue0<data_type>::Root()
{
	return 1;
}
...
template <class data_type>
data_type MaxPriorityQueue0<data_type>::GetData(int node)
{
	return PQ.at(node);
}

template <class data_type>
int MaxPriorityQueue0<data_type>::Parent(int node)
{
	return (node / 2);
}

template <class data_type>
void MaxPriorityQueue0<data_type>::Exchange(int c, int p)
{
	data_type data;
	data = PQ.at(c);
	PQ.at(c) = PQ.at(p);
...
template <class data_type>
data_type MaxPriorityQueue0<data_type>::ExtractLastFromPQ()
{
	data_type data;
	data = PQ.back();
	PQ.pop_back();
...
template <class data_type>
bool MaxPriorityQueue0<data_type>::HasChildren(int node)
{
	if ((PQ.size() - 1) >= (2 * node))
		return true;
	else
...
template <class data_type>
int MaxPriorityQueue0<data_type>::MaxChild(int node)
{
	if ((PQ.size() - 1) > (2 * node))
	{
		if (PQ.at(2 * node) < PQ.at(2 * node + 1))
...
template <class data_type>
void MaxPriorityQueue0<data_type>::InsertInPQ(data_type data)
{
	AddLast(data);
	int c = (int)PQ.size() - 1;
	int p = 0;
...
template <class data_type>
data_type MaxPriorityQueue0<data_type>::ExtractMaxFromPQ()
{
	data_type c = PQ.at(Root());
	PQ.at(Root()) = ExtractLastFromPQ();
	int i = Root();
...
template <class data_type>
void MaxPriorityQueue0<data_type>::Show()
{
	vector <int>::iterator Iter;
	cout << "PriorityQueue:\n";
	Iter = PQ.begin();
...
template <class data_type>
data_type MaxPriorityQueue0<data_type>::FindMaxInPQ()
{
	data_type data = PQ.at(Root());
	return data;
}
...
template <class data_type>
int MaxPriorityQueue0<data_type>::SizePQ()
{
	return PQ.size() - 1;
}
